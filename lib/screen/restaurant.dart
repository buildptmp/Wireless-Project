            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hideout.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Column(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Flexible(
                            child: ClipRRect(
                              child: Image.asset('assets/lobster.jpg'),
...
class RoundButton extends StatelessWidget {
  final IconData icon;
  final onTap;
  const RoundButton({Key? key, required this.icon, this.onTap}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
